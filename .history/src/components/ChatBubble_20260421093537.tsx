      ...
      >
        ...
        <div
          ...
          className={cn(
            ...
            isImage && !message.isDeleted ? "p-1" : "px-3.5 py-2.5 text-sm leading-relaxed",
            message.isDeleted
              ? "bg-transparent border border-dashed border-white/20 text-white/40 italic rounded-2xl"
              : isMe
              ? "bubble-sent"
              : "bubble-recv"
          )}
