...
export default function GifPicker({
  ...
  return (
    <div className="absolute bottom-20 right-0 z-50 w-[360px] h-[460px] flex flex-col rounded-2xl shadow-2xl border bg-white dark:bg-slate-900 dark:border-slate-700 overflow-hidden">
