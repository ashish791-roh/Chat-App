...
import DocViewer, { DocViewerRenderers } from "@cyntler/react-doc-viewer";import TypingIndicator from "@/components/TypingIndicator";
...
export default function ChatPage() {
  ...
  return (
    <main className="flex h-screen bg-white dark:bg-slate-950 overflow-hidden text-gray-900 dark:text-gray-100 transition-colors relative">
      ...
      <ChatEmojiPicker isOpen={showEmoji} onSelect={(emoji) => handleInputChange(input + emoji)} />

        return (
  <main className="flex h-screen bg-white dark:bg-slate-950 overflow-hidden ...">
    
    {/* --- PLACE THE PREVIEW MODAL HERE --- */}
    {previewFile && (
      <div className="fixed inset-0 z-[200] bg-black/80 backdrop-blur-sm flex flex-col animate-in fade-in duration-200">
        <div className="p-4 flex justify-between items-center bg-white dark:bg-slate-900 border-b dark:border-slate-800">
          <span className="font-bold text-sm uppercase tracking-widest text-gray-500">File Preview</span>
          <button 
