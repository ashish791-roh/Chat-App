...
export default function ChatPage() {
  ...
  // ✅ NEW LOGIC (persistent delete for me)
         ...
         GET / 200 in 43ms (next.js: 4ms, application-code: 39ms)
[browser] Uncaught TypeError: onGifClick is not a function
    at onGifClick (src/components/GifPicker.tsx:167:15)
    at a (<anonymous>)
    at Array.map (<anonymous>)
    at Array.map (<anonymous>)
    at GifPicker (src/components/GifPicker.tsx:159:11)
    at ChatPage (src/app/page.tsx:710:21)
  165 |             onGifClick={(gif, e) => {
  166 |               e.preventDefault();
> 167 |               onGifClick(gif.images.fixed_height.url);
      |               ^
  168 |             }}
  169 |             renderGif={(gif, i) => {
  170 |               const url = gif.images.fixed_height.url;
✓ Compiled in 5.7s
✓ Compiled in 1918ms
 GET / 200 in 378ms (next.js: 184ms, application-code: 194ms)
 GET / 200 in 126ms (next.js: 34ms, application-code: 92ms)
 GET / 200 in 45ms (next.js: 4ms, application-code: 41ms)
            ...
            {isRecording ? (
              ...
              <>
                ...
                {[
                  ...
                  { icon: Gift, action: () => { setOpenMedia(false); setIsGiftModalOpen(true); }, title: "Gift" },
                  {
                    icon: CoinsIcon,
