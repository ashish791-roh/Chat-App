  ...
  return (
    <main className="flex h-screen overflow-hidden relative z-10 pb-16 md:pb-0 bg-gradient-to-br from-slate-900 via-purple-900/10 to-slate-900">
      ...
      <aside
        ...
        style={{ background: "var(--bg-panel)", borderColor: "var(--border)", width: sidebarCollapsed ? 60 : 300, transition: 'width 0.3s ease' }}
      >
        {/* ── Sidebar Header ── */}
        <div className="px-5 pt-6 pb-4" style={{ borderBottom: "1px solid var(--border)" }}>
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-1">
              ...
              <button onClick={() => setSidebarCollapsed(!sidebarCollapsed)} className="hidden md:flex w-8 h-8 flex items-center justify-center rounded-xl transition-colors hover:bg-white/8" style={{ color: "var(--text-secondary)" }} title="Toggle sidebar">
                <Menu size={16} />
              </button>
