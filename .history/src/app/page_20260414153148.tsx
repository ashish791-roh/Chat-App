            ...
            {isRecording ? (
              ...
              <>
                ...
                {[
                  ...
                  { icon : smiley, action: () => setOpenMedia(true), title: "Emoji / GIF / Stickers" },
                ].map(({ icon: Icon, action, title }) => (
                  <button key={title} type="button" onClick={action} title={title}
                    className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-white/8 transition-all"
