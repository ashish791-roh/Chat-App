...
import { ref as fireStorageRef, uploadBytesResumable, getDownloadURL } from "firebase/storage";
...
const handleReaction = useCallback(async (emoji: string) => {
 ...
 const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  try {
    ...
    const fileStorageRef = fireStorageRef(
      storage,
    ...
    uploadTask.on(
      ...
      async () => {
        try {
          ...
          console.log("REAL URL:", downloadURL); // DEBUG
          ...
          await addDoc(collection(db, "chats", chatId, "messages"), {
            ...
            text: downloadURL, // ✅ ALWAYS FIREBASE URL
