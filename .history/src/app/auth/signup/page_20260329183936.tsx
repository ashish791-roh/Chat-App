...
import { Mail, Phone, Lock, Github as GithubIcon, Globe, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-white/20 dark:border-slate-800 rounded-[2.5rem] p-8 shadow-2xl">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <button className="flex justify-center py-3 bg-gray-50 dark:bg-slate-800 rounded-2xl hover:bg-gray-100 dark:hover:bg-slate-700 transition-all border dark:border-slate-700"><GithubIcon size={20} /></button>
      </div>
