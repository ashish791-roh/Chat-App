...
export default function ChatPage() {
  ...
  return (
    <main className="flex h-screen overflow-hidden relative z-10">
      ...
      {openMedia && ( <MediaPicker onSelect={(item, type) => { if (type === "emoji") { setInput(prev => prev + item); } if (type === "gif") { handleGifSend(item.images.original.url); } setOpenMedia(false); }} />)}
            ...
            {isRecording ? (
              ...
              <>
                ...
                {[
                  ...
                  { icon: ImagePlay as="gif", action: () => setOpenMedia(true), title: "Send GIF/Emoji" },
