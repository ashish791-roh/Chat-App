...
import { 
  ...
  Smile, Gift, ChevronLeft, Phone, Video, X, Trash, Trash2, Reply, Settings 
} from "lucide-react";
      ...
      <aside className="w-80 border-r border-gray-200 dark:border-slate-800 hidden md:flex flex-col bg-gray-50 dark:bg-slate-900/50">
        ...
        <div className="p-4 flex-1 overflow-y-auto space-y-4">
          <div onClick={() => setIsProfileOpen(true)} className="group flex items-center gap-3 p-3 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-transparent hover:border-blue-500 transition-all cursor-pointer">
            ...
            <div className="flex-1 text-sm font-bold">Ashish Yadav<p className="text-[10px] text-gray-400 font-normal">Online</p></div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border dark:border-slate-700">
            ...
            <div className="flex-1 text-sm font-semibold">Anchal<p className="text-xs text-green-500">Active now</p></div>
          </div>
        </div>
      ...
      <section className="flex-1 flex flex-col h-full bg-white dark:bg-slate-950 relative transition-all duration-300">
        <header className="h-[73px] px-4 md:px-6 border-b border-gray-200 dark:border-slate-800 flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-20">
          <div className="flex items-center gap-2 md:gap-3 cursor-pointer" onClick={() => setIsMediaOpen(true)}>
            ...
            <div><h2 className="font-bold text-gray-800 dark:text-white leading-tight">Anchal</h2><span className="text-[11px] text-green-500 font-medium uppercase font-bold tracking-tighter">Active now</span></div>
          </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 relative z-20">
          ...
          {/* EMOJI TOPUP (POSITIONED LEFT ABOVE ICON) */}
          {showEmoji && (
          ...
          {/* GIF TOPUP */}
          {showGif && (
            <div className="absolute bottom-20 right-4 md:right-6 z-[100] animate-in slide-in-from-bottom-2 duration-200">
