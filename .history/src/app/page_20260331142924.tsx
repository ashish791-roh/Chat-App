          ...
          <div onClick={() => setIsProfileOpen(true)} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-slate-800 cursor-pointer group">
             <div className="relative">
                {currentUser.profilePic ? (
                    <img src={currentUser.profilePic} className="w-10 h-10 rounded-full object-cover border-2 border-blue-600" alt="Me" />
                ) : (
             ...
             <div className="flex-1 min-w-0">
                ...
                <p className="text-[9px] text-gray-400 uppercase font-bold">My Status: Online</p>
             </div>
